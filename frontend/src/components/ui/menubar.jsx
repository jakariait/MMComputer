...
function MenubarTrigger({ className, ...props }) {
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        'flex items-center rounded-sm px-1 py-1 text-sm font-medium outline-hidden select-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground',
        className,
      )}
      {...props}
    />
